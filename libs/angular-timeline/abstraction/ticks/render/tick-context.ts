...
export class TickContext
{
    ...
    public readonly screenPosition: BehaviorSubject<number>;
    ...
    constructor(item: TickItem)
    {
        ...
        this.screenPosition = new BehaviorSubject(item.screenPosition);
    ...
    public update(item: TickItem)
    {
        ...
        this.screenPosition.next(item.screenPosition);
